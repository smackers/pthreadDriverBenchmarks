...
void *whoop_wrapper_read_nvram_1(void* args)
{
 read_nvram(whoop_file_1, whoop_buf, whoop_int, whoop_loff_t);
}

void *whoop_wrapper_read_nvram_2(void* args)
{
 read_nvram(whoop_file_1, whoop_buf, whoop_int, whoop_loff_t);
}
...
void main()
{
 ...
 pthread_t pthread_t_read_nvram_1;
 pthread_t pthread_t_read_nvram_2;


 pthread_create(&pthread_t_read_nvram_1, ((void *)0), whoop_wrapper_read_nvram_1, ((void *)0));
 pthread_create(&pthread_t_read_nvram_2, ((void *)0), whoop_wrapper_read_nvram_2, ((void *)0));


 pthread_join(pthread_t_read_nvram_1, ((void *)0));
 pthread_join(pthread_t_read_nvram_2, ((void *)0));
