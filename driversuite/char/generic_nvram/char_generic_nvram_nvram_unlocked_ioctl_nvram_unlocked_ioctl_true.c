...
void main()
{
	...
	pthread_create(&pthread_t_nvram_unlocked_ioctl_1, NULL, whoop_wrapper_nvram_unlocked_ioctl_1, NULL);
	pthread_create(&pthread_t_nvram_unlocked_ioctl_2, NULL, whoop_wrapper_nvram_unlocked_ioctl_2, NULL);

	// Wait for threads to finish
	pthread_join(pthread_t_nvram_unlocked_ioctl_1, NULL);
	pthread_join(pthread_t_nvram_unlocked_ioctl_2, NULL);
