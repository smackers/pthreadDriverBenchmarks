...
void *whoop_wrapper_nvram_llseek_1(void* args)
{
 nvram_llseek(whoop_file_3, &whoop_loff_t, whoop_int);
}

void *whoop_wrapper_nvram_llseek_2(void* args)
{
 nvram_llseek(whoop_file_3, &whoop_loff_t, whoop_int);
}
...
void main()
{
 ...
 pthread_t pthread_t_nvram_llseek_2;


 pthread_create(&pthread_t_nvram_llseek_1, ((void *)0), whoop_wrapper_nvram_llseek_1, ((void *)0));
 pthread_create(&pthread_t_nvram_llseek_2, ((void *)0), whoop_wrapper_nvram_llseek_2, ((void *)0));


 pthread_join(pthread_t_nvram_llseek_1, ((void *)0));
 pthread_join(pthread_t_nvram_llseek_2, ((void *)0));
